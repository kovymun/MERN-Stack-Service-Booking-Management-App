/**TAC SERVICE BOOKING APP SCHEDULE BOOKING FORM REACT COMPONENT FILE - ADMIN USER**/
...
This component affords the manager of the service bookings department (admin user) the ability to schedule new customer service bookings. 
The information fields to be entered by the user are the following:
* The Customer Name.
...
export default function ScheduleBookingFormAdmin({
  handleAddBooking,
  handleServiceType,
  handleDate,
  customerValue,
...
Utilized the React-Bootstrap Button, Form, Col, Row components as an interface, for the admin user to enter the relevant information to schedule the booking.
Referenced the React-Bootstrap documentation website for this information. 
https://react-bootstrap.github.io/

maxLength attribute:
Researched and utilized the maxLength HTML attribute, to limit the number of characters the admin user can enter for a particular field.
